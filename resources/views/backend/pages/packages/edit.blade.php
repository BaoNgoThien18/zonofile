    ...
    <div class="row">
        ...
        <section class="col-lg-12">
            <div class="card card-primary card-outline">
               ...
               <div class="card-body">
                <form action="{{ route('packages.update', $row->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <label>Mô tả:</label>
                            <textarea name="description" class="form-control summernote"><?= $row->description ?></textarea>
                        </div>
                        <div class="col-12">
                            <label>Giá:</label>
                        ...
                        <div class="col-12">
                            ...
                            <input type="number" value="{{ $row->capacity }}" name="capacity" class="form-control">
                        </div>
                        <div class="col-12">
